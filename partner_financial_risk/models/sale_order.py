        ...
        for obj in self:            
            if obj.need_check_credit_limit==True:
                ...
                if future_max_credit_limit_allow<=0:
                    allow_confirm = False
                    raise Warning(_('The sale cannot be confirmed because there is no available credit or the total amount of this sale is greater than the available credit) + (%s)' %  ((future_max_credit_limit_allow)))
        #allow_confirm
